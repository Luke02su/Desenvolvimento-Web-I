        ...
        public function getConnection() { //
            try { // tentando se conectar no banco
                ...
                $this->con = new PDO ( // Garante algumas coisas: segurança etc. Recebe um novo objeto. Recebe os parâmetros abaixo
                    $this->dbType.":host=".$this->host.";port=3307;dbname=".$this->db, // primeiro parãmetro: String de conexão. Pode mudar para algum outro banco
                    $this->user,
                    $this->senha,
            ...
            catch(PDOException $ex) { // Erro ao conectar
